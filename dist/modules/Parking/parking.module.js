...
exports.ParkingModule = ParkingModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: parking_entity_1.Parking.name, schema: parking_entity_1.ParkingSchema }]),
        ],
        controllers: [parking_controller_1.ParkingController],
        providers: [parking_service_1.ParkingService, parking_repository_1.ParkingRepository],
    })
], ParkingModule);
